class CardComponent extends Component {
  ...
  render() {
            ...
            <div class="card">
              <div class="flip">
                <div class="front">
                  ...
                  <a class="coins__btn modal--link" href="#coin?id=${id}">More Info</a>
                </div>
              </div>
            </div>
    ...
    // Mounted here //
    getRandomColor(".strip-top");
    getRandomColor(".strip-bottom");
